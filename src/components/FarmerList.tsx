...
import { Search, Filter, ChevronRight, User, MapPin, TrendingUp, ShieldCheck, ArrowRight, MoreVertical, Calendar, Download } from 'lucide-react';
...
export default function FarmerList({ onFarmerClick }: { onFarmerClick: (id: number) => void }) {
    ...
    >
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-3">
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-100 rounded-2xl text-gray-700 font-bold uppercase tracking-widest text-xs hover:bg-gray-50 transition-all shadow-sm">
            <Filter size={16} />
            Filter
          </button>
